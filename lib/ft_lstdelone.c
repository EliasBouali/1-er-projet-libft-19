...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/09 16:21:05 by ebouali           #+#    #+#             */
/*   Updated: 2025/04/10 15:34:42 by ebouali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    // Création d'un élément de liste avec 
    // une chaîne de caractères dynamiquement allouée
    t_list *node = ft_lstnew(malloc(6));  
// On alloue de la mémoire pour stocker "Hello"
...
// Normalement l'accès est impossible
