...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/10 11:55:42 by ebouali           #+#    #+#             */
/*   Updated: 2025/04/10 16:11:58 by ebouali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/* on cast avec un char * car s est un const char* en argument mais que 
  * last_occurence est un char* cela peut posé des souci
  * et si on declare un const char pour last_occurence nous devons aussi  
  * appeller notre fonction cont char *strrchr est cela 
  * ne respect pas la definition de la fonction strrchr */
/* On cast en (char *) car s est un const char *, 
  * mais strrchr() doit retourner un char *.
...
int main(void)
{
    ...
    // Devrait afficher l'adresse de la fin de la chaîne
